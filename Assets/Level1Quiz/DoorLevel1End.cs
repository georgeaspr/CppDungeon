...
public class DoorLevel1End : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {               
            ...
            if (phasKey)
            {
                ...
                PlayerController.score = (PlayerController.health * 10) + PlayerController.score;
                string textToSave = PlayerController.score.ToString();
                string filePath = Path.Combine(Application.persistentDataPath, "level1.txt");
